...
export class DomainsNS {
    ...
    async create(sld: string, tld: string, nameserver: string, ip: string): Promise<DomainNsCreateResult> {
   ...
   async delete(sld: string, tld: string, nameserver: string): Promise<DomainNsDeleteResult> {
    ...
    async update(sld: string, tld: string, nameserver: string, ip: string, oldIp: string): Promise<DomainNsUpdateResult> {
