...
import {
    ...
    GetListSSLParams, ReissueSSLParams,
    RenewSSLParams,
    SSLType
...
import {
    GetApproverEmailListResult, SSLActivateResult,
    SSLCreateResult, SSLEditDcvMethodResult, SSLGetInfoResult,
    SSLParseCsrResult, SSLPurchaseMoreSansResult, SSLRenewResult,
    SSLResult
...
export class SSL {
    ...
    async getApproverEmailList(domainName: string, certificateType?: SSLType): Promise<GetApproverEmailListResult> {
    ...
    async activate(certificateId: number, params: Omit<ActivateSSLParams, "certificateId">): Promise<SSLActivateResult> {
    ...
    async renew(certificateId: number, params: Omit<RenewSSLParams, "certificateId">): Promise<SSLRenewResult> {
    ...
    async reissue(certificateId: number, params: Omit<ReissueSSLParams, "certificateId">): Promise<SSLActivateResult> {
    ...
    async purchaseMoreSANS(certificateId: number, numberOfSANSToAdd: number): Promise<SSLPurchaseMoreSansResult> {
    ...
    async editDCVMethod(certificateId: number, params: Omit<EditDCVMethodParams, "certificateId">): Promise<SSLEditDcvMethodResult> {
